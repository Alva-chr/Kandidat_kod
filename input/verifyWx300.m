function [frequency, x0, y0, m_x, m_y,W_x, W_y, roomLength, roomHeight, roomX, roomY, mu, lambda,rho, BC, eig_answer, plot_answer, T, snapshot, snapshotName,movie,C_p,C_s,decibel_txt, save_movie] = verifyWx300()
...
W_x = roomX + 150; %Låst, VERIFIERA rum_pos + (30, 60, 90, 120)
...
%Snapshot wanted?
snapshot = "N";
snapshotName = coder.mfunctionname;
