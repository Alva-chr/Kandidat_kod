function [frequency, x0, y0, m_x, m_y,W_x, W_y, roomLength, roomHeight, roomX, roomY, mu, lambda,rho, BC, eig_answer, plot_answer, T, snapshot, snapshotName,movie,C_p,C_s,decibel_txt, save_movie] = simy_3()
%Input parameters for point source
frequency = 5; %1,5,10,15
x0 = 5; %Låst
y0 = 5; %Låst
...
roomY = ( W_y - roomHeight) - 12; %testa 2 olika (2,12)
