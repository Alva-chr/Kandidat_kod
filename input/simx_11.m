function [frequency, x0, y0, m_x, m_y,W_x, W_y, roomLength, roomHeight, roomX, roomY, mu, lambda,rho, BC, eig_answer, plot_answer, T, snapshot, snapshotName,movie,C_p,C_s,decibel_txt, save_movie] = simx_3()
%Input parameters for point source
frequency = 11; %1,5,10,15
x0 = 5; %Låst
y0 = 5; %Låst
